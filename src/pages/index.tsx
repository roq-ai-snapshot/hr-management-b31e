  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Empower your workforce with HR Management - Streamlining employee data, payroll, time tracking, vacations, and performance evaluations in one central hub."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Empower your workforce with HR Management - Streamlining employee data, payroll, time tracking, vacations, and performance evaluations in one central hub.`}
            </Text>
            <Box
